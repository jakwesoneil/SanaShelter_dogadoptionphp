...
<body>
    ...
    <main class="container mt-5">
        ...
        <div class="row">
            ...
            $sql_insert_data = "INSERT INTO animals (name, species, breed, description) VALUES
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '        <td><button class="btn btn-primary" onclick="openAdoptionModal(\'' . $row['name'] . '\', \'' . $row['species'] . '\', \'' . $row['breed'] . '\', \'' . $row['description'] . '\')">Adopt Now</button></td>';
                    echo '    </tr>';
                }
                echo '    </tbody>';
                echo '</table>';
    ...
    <script>
        ...
        $(document).ready(function () {
            $(".owl-carousel").owlCarousel({
                ...
                nav: true,
                dots: false,
                navText: ["<img src='img/previous.png' alt='Previous'>", "<img src='img/nexts.png' alt='Next'>"], // Custom navigation icons
                responsive: {
                    0: {
                        items: 1
                    },
