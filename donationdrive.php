...
<!-- Donation Drive Start -->
<div class="container-fluid bg-primary text-white mt-5 py-5 px-sm-3 px-md-5">
    <div class="row pt-5">
        <div class="col-lg-8 col-md-12 mb-5">
            <h1 class="mb-3 display-5 text-capitalize text-white"><span class="text-light">Join Our Donation Drive</span> And Help Abused and Neglected Animals</h1>
            <p class="m-0">Your generous donations can make a significant difference in the lives of animals in need. We rely on the support of kind-hearted individuals like you to continue our mission of providing care and shelter to animals who have suffered from abuse and neglect. Every contribution counts!</p>
            <div class="d-flex mt-4">
                <h5 class="text-light align-self-center mb-0 ml-3">Contact us through:</h5>
                <a href="mailto:officialsanashelter@gmail.com" target="_blank" class="btn btn-outline-light rounded-circle text-center mr-2 px-0" style="width: 36px; height: 36px;"><i class="fa fa-envelope"></i></a>
            </div>
        </div>
        <div class="col-lg-4 col-md-12">
            <h5 class="text-light mb-3">Donation Links</h5>
            <img src="img/donation.png" alt="Donation Drive" class="img-fluid">
            <div class="mt-3">
                <h5 class="text-light">GCash:</h5>
                <p class="text-light">Gcash # 09093918007</p>
                <p class="text-light">Name: Ernie Garcia</p>
                <a href="https://www.gcash.com/" target="_blank" class="btn btn-light mt-3">GCash</a>

                <h5 class="text-light mt-4">PayPal:</h5>
                <p class="text-light">PayPal Account: garcia_1029@yahoo.com</p>
                <p class="text-light">Name: Ernie Garcia</p>
                <a href="https://www.paypal.com/donate" target="_blank" class="btn btn-light mt-3">PayPal</a>
            </div>
        </div>
    </div>
</div>
