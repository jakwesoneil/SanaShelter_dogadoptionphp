                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h3 class="text-white mb-3 d-none d-sm-block">A Non-Governmental Organization (NGO)</h3>
                            <h1 class="display-3 text-white mb-3">Animal Welfare Advocate</h1>
                            <h5 class="text-white mb-3 d-none d-sm-block">San Jose, Baras, Philippines</h5>
                            <a href="" class="btn btn-lg btn-primary mt-3 mt-md-4 px-4">How to Help</a>
...
<div class="container mt-5 pt-5 pb-3">
    <div class="d-flex flex-column text-center mb-5">
        <h1 class="display-4 m-0">Meet Our <span class="text-primary">Founder</span></h1>
    </div>
    <div class="row">
        <div class="col-lg-12 d-flex justify-content-center"> <!-- Wrap the entire column with a new div and apply 'd-flex justify-content-center' to center -->
            <div class="col-lg-3 col-md-6">
                <div class="team card position-relative overflow-hidden border-0 mb-4">
                    <img class="card-img-top" src="img/teams-1.jpg" alt="">
                    <div class="card-body text-center p-0">
                        ...
                        <div class="team-social d-flex align-items-center justify-content-center bg-dark">
                            <a class="btn btn-outline-primary rounded-circle text-center mr-2 px-0" style="width: 36px; height: 36px;" href="https://twitter.com/ernie_garcia"><i class="fab fa-twitter"></i></a>
                            <a class="btn btn-outline-primary rounded-circle text-center mr-2 px-0" style="width: 36px; height: 36px;" href="https://www.facebook.com/ernie.garcia.56679"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn btn-outline-primary rounded-circle text-center mr-2 px-0" style="width: 36px; height: 36px;" href="https://www.linkedin.com/in/ernie-garcia"><i class="fab fa-linkedin-in"></i></a>
                            <a class="btn btn-outline-primary rounded-circle text-center px-0" style="width: 36px; height: 36px;" href="https://www.instagram.com/ernie_garcia"><i class="fab fa-instagram"></i></a>
                        </div>
                    </div>
                </div>
            </div>
